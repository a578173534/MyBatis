...
import com.ggs.dao.impl.StudentDaoImpl;
...
public class TestMyBatis {
    ...
    public void testSelectStudents() {
        ...
        //com.ggs.dao.StudentDao
        StudentDao dao = new StudentDaoImpl();

        /**
         * List<Student> studentList  = dao.selectStudents(); 调用
         * 1.dao对象，类型是StudentDao，全限定名称是：com.ggs.dao.StudentDao
    ...
    public void testInsertStudent() {
        StudentDao dao = new StudentDaoImpl();
        Student student = new Student(1005, "盾山", "dunshan@qq.com", 20);
